...
export default function SearchBar() {
  ...
  return (
    <div
      className={`flex w-64 items-center rounded-full border-2 border-parchment-950 bg-inherit transition-width duration-500 focus-within:w-96 ${query && "w-96"}`}
    >
      ...
      <input
        ...
        type="text"
        className="peer h-full bg-inherit py-1.5 placeholder:text-parchment-950 placeholder:opacity-75 focus:outline-none focus:ring-0"
